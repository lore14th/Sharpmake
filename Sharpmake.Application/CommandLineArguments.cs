...
of the project generated by /generateDebugSolution. ex: /debugSolutionStartArguments(""/diagnostics"")")]
            ...
            [CommandLine.Option("buildToolchain", @"Specifies the target development environment for TinfoilBuildTool: ex: /buildToolchain(""name"")")]
            public void CommandLineDevEnv(string buildToolchain)
            {     
                TinfoilBuildToolArguments.BuildToolchain = (DevEnv)Enum.Parse(typeof(DevEnv), buildToolchain, true);
            }
