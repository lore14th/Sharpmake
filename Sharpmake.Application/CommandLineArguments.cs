...
of the project generated by /generateDebugSolution. ex: /debugSolutionStartArguments(""/diagnostics"")")]
            ...
            // TinfoilBuildTool: Add extra command line arguments
            [CommandLine.Option("targetName", @"Specifies the target name for TinfoilBuildTool builds: ex: /buildProjects(""targetname"")")]
            public void CommandLineTargetName(string targetName)
            {
                TinfoilBuildToolArguments.TargetName = targetName;
            }
