...
namespace Sharpmake.Application
{
    public static partial class Program
    {
        public class Argument
        {
            ...
            public TinfoilBuildToolArguments TinfoilBuildToolArguments = new TinfoilBuildToolArguments();
            public bool IgnorePathToLower = false; // If active, don't make filepaths lowercase
            //~Tinfoil
...
of the project generated by /generateDebugSolution. ex: /debugSolutionStartArguments(""/diagnostics"")")]
            ...
            [CommandLine.Option("debugSolutionPath", @"Specifies the path of the solution generated by /generateDebugSolution. Absolute or relative to current directory. ex: /debugSolutionPath(""generated/debug"")")]
            public void CommandLineDebugSolutionPath(string path)
            {
                DebugSolutionPath = path;
            }

            [CommandLine.Option("debugSolutionDevEnv", @"Specifies the devenv version of the solution generated by /generateDebugSolution. ex: /debugSolutionDevEnv(""vs2022"")")]
            public void CommandLineDebugSolutionDevEnv(string devEnv)
            {
                if (!Enum.TryParse(devEnv, out DebugSolutionDevEnv))
                    throw new Error($"Invalid /debugSolutionDevEnv argument '{devEnv}'");
            }

            // Tinfoil: Add extra command line arguments
            [CommandLine.Option("buildProjects", @"Specifies if TinfoilBuildTool is in build mode: ex: /buildProjects(<true|fakse>)")]
            public void CommandLineBuildProjects(bool buildProjects)
            {
                TinfoilBuildToolArguments.BuildProjects = buildProjects;
            }

            [CommandLine.Option("projectConfig", @"Specifies the ProjectConfiguration class name for TinfoilBuildTool: ex: /projectConfig(""name"")")]
            public void CommandLineProjectConfig(string configClass)
            {
                TinfoilBuildToolArguments.ProjectConfigurationClass = configClass;
            }

            [CommandLine.Option("devEnv", @"Specifies the target development environment for TinfoilBuildTool: ex: /devEnv(""name"")")]
            public void CommandLineDevEnv(string devEnvName)
            {
                TinfoilBuildToolArguments.DevEnvName = devEnvName;
            }

            [CommandLine.Option("ignorePathToLower", @"Do not force filepaths to lower automatically: ex: /ignorePathToLower")]
            public void CommandLineIgnorePathToLower()
            {
                IgnorePathToLower = true;
            }
            // ~Tinfoil
...
ex: /forcecleanup( ""sharpmakeautocleanupdb.bin"" ")]
